jQuery.bootstrapLoading = {
    start: function (options) {
        ...
        style="position:fixed;left:0;top:0;_position: absolute;width:100%;height:‘ + _PageHeight + ‘px;background:‘ + options.backgroundColor + ‘;opacity:‘ + options.opacity + ‘;filter:alpha(opacity=‘ + options.opacity * 100 + ‘);z-index:‘ + options.zindex + ‘;"><div id="loadingTips" style="position: absolute; cursor1: wait; width: auto;border-color:‘ + options.borderColor + ‘;border-style:‘ + options.borderStyle + ‘;border-width:‘ + options.borderWidth + ‘px; height:80px; line-height:80px; padding-left:80px; padding-right: 5px;border-radius:10px;  background: ‘ + options.backgroundColor + ‘ url(/Content/bootstrap-loading/images/loading.gif) no-repeat 5px center; color:‘ + options.TipsColor + ‘;font-size:20px;">‘ + options.loadingTips + ‘</div></div>‘;
